...
Slot Machine because it is the most viable component with the least amount of complications. The other 2 options were has issues with accessing variables and requires additional considerations. I also want to make something fun and gamble.
